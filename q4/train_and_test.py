...
with open('../data/y_train_full.pickle', 'rb') as handle:
    Y_train = pickle.load(handle)
with open('../data/y_test_full.pickle', 'rb') as handle:
    Y_test = pickle.load(handle)
with open('../data/y_valid_full.pickle', 'rb') as handle:
...
plt.savefig('auc_model_' + str(model_name) + '_' + str(epochs) + '_' + str(learning_rate) + '_' + str(batch_size) + '_' + str(loss_fn) + '.png')
